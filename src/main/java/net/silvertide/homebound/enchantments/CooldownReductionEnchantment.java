...
public class CooldownReductionEnchantment extends Enchantment {
    public CooldownReductionEnchantment() {
        super(Rarity.VERY_RARE, EnchantmentCategory.create("homebound_item", item -> item instanceof HomeWarpItem), new EquipmentSlot[]{EquipmentSlot.MAINHAND});
    }
