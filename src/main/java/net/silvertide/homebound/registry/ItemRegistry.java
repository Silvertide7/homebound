...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> HEARTHWOOD = ITEMS.register("hearthwood", () -> new HomeWarpItem(new HomeWarpItem.Properties().cooldown(520).maxDistance(160).useDuration(3).isEnchantable(false).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> DAWN_STONE = ITEMS.register("dawn_stone", () -> new HomeWarpItem(new HomeWarpItem.Properties().cooldown(3300).useDuration(8).canDimTravel(true).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> SUN_STONE = ITEMS.register("sun_stone", () -> new HomeWarpItem(new HomeWarpItem.Properties().cooldown(3000).useDuration(7).canDimTravel(true).rarity(Rarity.EPIC).isSoulbound(true)));
    ...
    public static final RegistryObject<Item> TWILIGHT_STONE = ITEMS.register("twilight_stone", () -> new VariableCooldownWarpItem(new HomeWarpItem.Properties().useDuration(10).canDimTravel(true).rarity(Rarity.EPIC).isSoulbound(true), 3600, 720,50));
