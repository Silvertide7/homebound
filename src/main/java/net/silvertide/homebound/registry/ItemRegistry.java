...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> SUN_STONE = ITEMS.register("sun_stone", () -> new HomeWarpItem(new HomeWarpItem.Properties().cooldown(2700).useDuration(7).canDimTravel(true).rarity(Rarity.EPIC).isSoulbound(true)));
    ...
    public static final RegistryObject<Item> TWILIGHT_STONE = ITEMS.register("twilight_stone", () -> new VariableCooldownWarpItem(new HomeWarpItem.Properties().useDuration(10).canDimTravel(true).rarity(Rarity.EPIC).isSoulbound(true), 3600, 600,60));
