...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> SUN_STONE = ITEMS.register("sun_stone", () -> new HomeWarpItem(new HomeWarpItem.Properties().cooldown(2700).useDuration(6).canDimTravel(true).rarity(Rarity.EPIC).isSoulbound(true)));
